...
<form id="snax-new-item-video" class="snax-form snax-form-without-media snax-form-prior-media snax-new-item" xmlns="http://www.w3.org/1999/html">
	<?php if ( 2 > count( snax_get_new_item_forms() ) ) : ?>
		<h2 class="snax-new-item-title"><?php esc_html_e( 'Add New Video', 'snax' ); ?></h2>
	<?php endif; ?>
	...
	<div class="snax-media">
		...
		<div class="snax-upload-preview" data-snax-media-id="<?php echo esc_attr( snax_get_user_uploaded_media_id( 'video' ) ); ?>">
			<div class="snax-upload-preview-inner"></div>
			<a href="#" class="snax-upload-preview-delete"><?php esc_html_e( 'Delete', 'snax' ); ?></a>
		</div>

		<?php snax_get_template_part( 'form-upload-media', 'video' ); ?>
	...
	<p class="snax-new-item-row-actions">
		<?php if ( current_user_can( 'snax_publish_items' ) ) : ?>
			<input type="submit" id="snax-add-video-item" value="<?php esc_attr_e( 'Publish', 'snax' ); ?>"/>
		<?php else : ?>
			<input type="submit" id="snax-add-video-item" value="<?php esc_attr_e( 'Submit for Review', 'snax' ); ?>"/>
		<?php endif; ?>
	</p>

	<?php do_action( 'snax_end_form_edit_item_video' ); ?>
</form>
